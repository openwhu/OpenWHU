...
using System.Text;
using System.Web;
namespace ocrfreamwork

{
    public class EmojiOCR123
    {
        // 通用文字识别
        ...
        {
            //这里要考虑下怎么返回结果。直接返回string的话好像运行不了。C:\Users\miles\Desktop\把卡.jpg
            string p = "C:\\Users\\miles\\Desktop\\把卡.jpg";
            string a = Getkeybyocr(p);
