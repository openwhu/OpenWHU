...
<table cellpadding=3 cellspacing=1 border=0 width=100%>
    <tr>
      <td width="100%" bgcolor="<%=Tabletitle%>" colspan=2><div align="left"><font color=<%=TableFont%>><p>&nbsp;&nbsp;<strong>*为必填项目 只有<a href="reg.asp"><font color=<%=TableFont%>>注册用户</font></a>能<a name="发表贴子">发表贴子</a></strong></font></td>
    </tr>
        ...
        <tr bgcolor="<%=Tablebody%>">
          <td width="14%"><b>主题标题</b></td>
          <td width="86%"><font color="<%=Tablecontent%>"><input name="subject" size=60 maxlength=80 value="">&nbsp;&nbsp;不得超过 50 个汉字
...
<INPUT TYPE="hidden" name="skin" value="<%=request("skin")%>">
        ...
        <tr bgcolor="<%=Tablebody%>"><font color="<%=Tablecontent%>">
          <td width="14%" valign="top"><b>当前心情</b><br><li>将放在贴子的前面<BR></td>
          <td width="86%">
...
<TEXTAREA name="<%=session("antry")%>" cols="80" rows="12" wrap=VIRTUAL title="可以使用Ctrl+Enter直接提交贴子">
<%
...
<BR><BR></td>
                ...
                <input type=Submit value="发 表" name=Submit> &nbsp; <input type="reset" name="Submit2" value="清 除">
                </td></form></tr>
      </table>
      </td>
    </tr>
