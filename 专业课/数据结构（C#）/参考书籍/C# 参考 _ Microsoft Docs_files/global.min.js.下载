...
var loc = {
    ...
    "description": "说明",
    "disable": "禁用",
    "disclaimer.archive": "将不再定期更新此内容。 若要了解如何获取此产品、服务或技术的支持，请查看 <a href=\"https://support.microsoft.com/en-us/lifecycle/selectindex\">Microsoft 产品生命周期</a>。",
    "disclaimer.archiveMachineTranslated": "本文属机器翻译。 将不再定期更新此内容。 若要了解如何获取此产品、服务或技术的支持，请查看 <a href=\"https://support.microsoft.com/en-us/lifecycle/selectindex\">Microsoft 产品生命周期</a>。",
    ...
    "enable": "启用",
    "error": "错误",
    "errorCreatingComment": "创建注释时出错。 如有需要，可在 <a data-bi-name=\"create-comment-on-github\" ms.cmpnm=\"create-comment-on-github\" href=\"{0}\">GitHub<span class=\"docon docon-navigate-external\" aria-hidden=\"true\"></span></a> 上重试。",
    "errorCreatingIssue": "创建问题时出错。 如有需要，可在 <a data-bi-name=\"create-issue-on-github\" ms.cmpnm=\"create-issue-on-github\" href=\"{0}\">GitHub<span class=\"docon docon-navigate-external\" aria-hidden=\"true\"></span></a> 上重试。",
    ...
    "filter.placeholder": "筛选器",
    "filter.text": "筛选器",
    "findALanguage": "查找语言",
    "footer.blog": "博客",
    "getHelp": "获取帮助",
    "giveDocumentationFeedback": "提供文档反馈",
    "giveFeedback": "提供反馈",
    "giveProductFeedback": "提供产品反馈",
    "heart": "爱心",
    ...
    "monikerFallback": "对 {0} 而言，请求的页面不可用。 已重定向到最相近的可用版本。",
    "monthsAgo": "{0} 个月前",
    "more": "更多",
    ...
    "share": "共享",
    "sharedArticleSubject": "[分享文章] {0}",
    "sharedesc": "共享本文",
    "signingIn": "正在登录…...",
    "signInToComment": "登录以评论",
    "signInToGiveDocumentationFeedback": "登录以提供文档反馈",
    "signInToGiveFeedback": "登录即可提供反馈",
    "signInToIncreaseRateLimit": "<a class=\"feedback-sign-in-button\" data-bi-name=\"rate-limit-sign-in\" ms.cmpnm=\"rate-limit-sign-in\" href=\"#\">登录</a>以提高 GitHub API 速率限制。",
    ...
    "test.request": "测试请求",
    "theme": "主题",
    "thereIsCurrentlyNoFeedback": "本文档当前无任何反馈。",
    ...
    "weeksAgo": "{0} 周前",
    "whatTypeOfFeedback": "想要提供什么类型的反馈？",
