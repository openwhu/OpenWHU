...
<table cellpadding=3 cellspacing=1 border=0 width=100%>
    <tr>
      <td width="100%" bgcolor="<%=Tabletitlecolor%>" colspan=2><div align="left"><font color=<%=TableFontColor%>><p><strong>&nbsp;&nbsp;<strong>*为必填项目 只有<a href="reg.asp"><font color=<%=TableFontColor%>>注册用户</font></a>能发表贴子</strong></font></td>
    </tr>
        <tr bgcolor=#FFFFFF>
          <td width="20%"><b>用户名</b></td>
          <td width="86%"><input name="username" value="<%'=htmlencode(membername)%><%=htmlencode(old_user)%>">&nbsp;&nbsp;<font color="red"><strong>*</strong></font><a href=reg.asp>您没有注册？</a> 
          </td>
        </tr>
        <tr bgcolor=#FFFFFF>
          <td width="14%"><b>密码</b></td>
          <td width="86%"><input name="passwd" type="password" value="<%=htmlencode(memberword)%>"><font color="red">&nbsp;&nbsp;<strong>*</strong></font><a href=lostpass.asp>忘记密码？</a>老师编辑不需要密码</td>
        </tr>
        <tr bgcolor=#FFFFFF>
          <td width="14%"><b>主题标题</b></td>
          <td width="86%"><input name="subject" size=60 maxlength=80 value="<%=htmlencode(Topic)%>">&nbsp;&nbsp;<font color="red"><strong>*</strong></font>不得超过 50 个汉字
...
<textarea class="smallarea" cols="80" name="<%=session("antry")%>" rows="12" wrap="VIRTUAL">
<%	if con<>"" then
...
%>
		...
		<tr>
                <td bgcolor=#FFFFFF valign=top colspan=2><b>点击表情图即可在贴子中加入相应的表情</B><br>&nbsp;
...
<%next%>
                ...
                <tr bgcolor=#FFFFFF>
                <td valign=top><b>选项</b><p><a href="javascript:openScript('help.asp',500,400)"><img src="pic/help_b.gif" border=0></a></font></td>
                <td valign=middle><input type=checkbox name="signflag" value="yes" checked>是否显示您的签名？<br>
